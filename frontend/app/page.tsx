      ...
      <section className="py-32 bg-zinc-50 border-t overflow-hidden relative">
        <div className="container mx-auto px-4 max-w-7xl relative z-10 text-center">
          <SectionHeader
            ...
            subtitle={
              <span className="text-slate-600 block text-base md:text-lg leading-relaxed max-w-2xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-left">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white p-6 md:p-8 rounded-[32px] hover:scale-105 shadow-md ring-2 ring-gray-100/50 hover:ring-rose-500 hover:ring-offset-4 hover:shadow-[0_0_60px_rgba(251,113,133,0.4)] group transition-all duration-500 relative"
            >
              ...
              <h4 className="text-lg font-bold text-slate-900 mb-2 tracking-tight font-serif">Crafted by Travelers</h4>
              <p className="text-slate-500 text-sm font-medium leading-relaxed">Dedicated to the offbeat soul. We verified the vibe so you don't have to.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-white p-6 md:p-8 rounded-[32px] hover:scale-105 shadow-md ring-2 ring-gray-100/50 hover:ring-blue-500 hover:ring-offset-4 hover:shadow-[0_0_60px_rgba(59,130,246,0.4)] group transition-all duration-500 relative"
            >
              ...
              <h4 className="text-lg font-bold text-slate-900 mb-2 tracking-tight font-serif">Zero Hidden Fees</h4>
              <p className="text-slate-500 text-sm font-medium leading-relaxed">No corporate markups or sneaky service charges. Pay the actual worth.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="bg-white p-6 md:p-8 rounded-[32px] hover:scale-105 shadow-md ring-2 ring-gray-100/50 hover:ring-yellow-400 hover:ring-offset-4 hover:shadow-[0_0_60px_rgba(250,204,21,0.4)] group transition-all duration-500 relative"
            >
              ...
              <h4 className="text-lg font-bold text-slate-900 mb-2 tracking-tight font-serif">Direct Negotiation</h4>
              <p className="text-slate-500 text-sm font-medium leading-relaxed">Direct host-to-traveler communication. Get the WhatsApp and build a connection.</p>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10 text-center">
          <SectionHeader
            ...
            title={
              <span className="text-white block mb-6 px-4">
                JOIN THE <span className="bg-gradient-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent">Hub</span> | One Umbrella for the Offbeat
              </span>
            }
            subtitle={
              <span className="text-slate-300 block text-base leading-relaxed max-w-2xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-left">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-[32px] hover:scale-105 hover:bg-white/10 hover:border-blue-500 hover:shadow-[0_0_60px_rgba(59,130,246,0.4)] group transition-all duration-500 relative"
            >
              <div className="bg-gradient-to-br from-blue-500/40 to-indigo-500/40 group-hover:bg-gradient-to-br group-hover:from-blue-400 group-hover:to-cyan-500 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.6)] border border-blue-400/40 group-hover:border-transparent w-12 h-12 rounded-2xl flex flex-none items-center justify-center mb-6 transition-all duration-500 group-hover:scale-110">
                <Umbrella className="w-6 h-6 text-blue-300 group-hover:text-white transition-colors" />
              </div>
              <h4 className="text-lg font-bold text-white mb-2 tracking-tight drop-shadow-sm font-serif">Under One Roof</h4>
              <p className="text-blue-200/70 text-sm font-medium leading-relaxed">Forget fragmented FB groups. Experience verified stays and real advice all in one curated hub.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-[32px] hover:scale-105 hover:bg-white/10 hover:border-rose-500 hover:shadow-[0_0_60px_rgba(251,113,133,0.4)] group transition-all duration-500 relative"
            >
              <div className="bg-gradient-to-br from-indigo-500/40 to-purple-500/40 group-hover:bg-gradient-to-br group-hover:from-rose-400 group-hover:to-pink-500 group-hover:shadow-[0_0_30px_rgba(251,113,133,0.6)] border border-indigo-400/40 group-hover:border-transparent w-12 h-12 rounded-2xl flex flex-none items-center justify-center mb-6 transition-all duration-500 group-hover:scale-110">
                <Users className="w-6 h-6 text-indigo-300 group-hover:text-white transition-colors" />
              </div>
              <h4 className="text-lg font-bold text-white mb-2 tracking-tight drop-shadow-sm font-serif">Real Travelers</h4>
              <p className="text-blue-200/70 text-sm font-medium leading-relaxed">Engage directly with experts and hosts. Absolute authenticity and zero corporate walls.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-[32px] hover:scale-105 hover:bg-white/10 hover:border-yellow-400 hover:shadow-[0_0_60px_rgba(250,204,21,0.4)] group transition-all duration-500 relative"
            >
              <div className="bg-gradient-to-br from-purple-500/40 to-fuchsia-500/40 group-hover:bg-gradient-to-br group-hover:from-yellow-400 group-hover:to-amber-500 group-hover:shadow-[0_0_30px_rgba(250,204,21,0.6)] border border-purple-400/40 group-hover:border-transparent w-12 h-12 rounded-2xl flex flex-none items-center justify-center mb-6 transition-all duration-500 group-hover:scale-110">
                <MessageSquare className="w-6 h-6 text-purple-300 group-hover:text-white transition-colors" />
              </div>
              <h4 className="text-lg font-bold text-white mb-2 tracking-tight drop-shadow-sm font-serif">Unfiltered Queries</h4>
              <p className="text-blue-200/70 text-sm font-medium leading-relaxed">Ask anything. Get straight, unfiltered answers immediately from the community source.</p>
            </motion.div>
          </div>
        </div>
      </section>
