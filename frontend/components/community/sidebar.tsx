        ...
        <aside className="hidden lg:flex flex-col gap-6 sticky top-24">
            ...
            <div className="bg-zinc-900/50 backdrop-blur-md rounded-2xl border border-white/5 ring-1 ring-white/10 shadow-2xl p-6">
                <div className="flex items-center gap-2 mb-6 text-white border-b border-white/5 pb-4">
                    ...
                    <h3 className="font-bold font-serif text-lg tracking-tight">Trending Travelers</h3>
                </div>
                <div className="space-y-4">
                    {topContributors.map((user, i) => (
                        <div key={i} className="flex items-center gap-3 cursor-pointer group">
                            <div className="w-7 text-[11px] font-black text-zinc-500 group-hover:text-zinc-300 transition-colors">
                                #{i + 1}
                            </div>
                            ...
                            <div className="min-w-0">
                                <p className="text-sm font-bold text-white group-hover:text-green-400 transition-colors leading-tight truncate">{user.name}</p>
