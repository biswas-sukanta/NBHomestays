        ...
        <section className="py-12 md:py-16">
            <div className="container mx-auto px-4 lg:px-6">
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        <h2 className="text-3xl font-bold font-heading tracking-tight text-white">Trending Stories</h2>
                ...
                <div className="lg:hidden -mx-4 px-4 overflow-x-auto">
                    <div className="flex gap-4 snap-x snap-mandatory scroll-px-4 pb-2">
                        {stories.slice(0, 3).map((story, idx) => (
                            ...
                            >
                                <div className="relative rounded-2xl overflow-hidden shadow-lg ring-1 ring-white/10 bg-zinc-950">
                                    <div className="relative aspect-[4/5]">
                                        {story.imageUrl ? (
                                            ...
                                            <div className="absolute inset-0 bg-zinc-900 border border-white/10 flex items-center justify-center p-8">
                                                <p className="text-zinc-500 font-serif italic text-center text-lg">&quot;{story.caption}&quot;</p>
                                            </div>
                                        )}
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 p-5">
                                        <div className="flex items-center gap-2 mb-2">
                                            <span className="px-3 py-1 bg-white/15 backdrop-blur-md rounded-full text-[10px] font-bold text-white uppercase tracking-wider border border-white/15">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div className="w-9 h-9 rounded-full bg-zinc-800 ring-1 ring-white/10 overflow-hidden">
                                                {story.authorAvatar ? (
                ...
                <div className="hidden lg:grid grid-cols-12 gap-6 h-auto min-h-[500px]">
                    <Link href={`/community#post-${featured.id}`} className="lg:col-span-7">
                        <div className="h-full relative group rounded-2xl overflow-hidden shadow-lg cursor-pointer ring-1 ring-white/10">
                            {featured.imageUrl ? (
                                <Image
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6">
                        {sideStories.map((story) => (
                            <Link key={story.id} href={`/community#post-${story.id}`} className="flex-1">
                                <div className="h-full relative group rounded-2xl overflow-hidden shadow-md cursor-pointer ring-1 ring-white/10">
                                    {story.imageUrl ? (
                                        <Image
                                            src={story.imageUrl}
                                            alt={story.location}
