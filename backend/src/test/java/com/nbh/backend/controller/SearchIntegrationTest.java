...
public class SearchIntegrationTest {
        ...
        public void shouldSearchHomestays() throws Exception {
                ...
                when(homestayRepository.search(anyString(), any(), any(), any(), any(), any(), any(), any(), any()))
                ...
                verify(homestayRepository).search(eq("Test"), any(), eq(null), eq(null), eq(null), eq(null), eq(null),
                                eq(null), eq(PageRequest.of(0, 20)));
        }
